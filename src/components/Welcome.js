            ...
            {movies.map((movie) => (
              ...
              >
                ...
                <RatingButtonContainer>
                  ...
                  <button onClick={(e) => handleWatchStatus(userId, movie.id, movie.title, "notAgain")}> Not again</button>
                  <button onClick={(e) => handleWatchStatus(userId, movie.id, movie.title, "no")}> No thanks</button>
                </RatingButtonContainer>
              </WelcomeMovieRow>
            ))}
          </section>
